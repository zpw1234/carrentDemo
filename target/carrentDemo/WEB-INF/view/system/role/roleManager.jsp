...
<script type="text/javascript">
    ...
    layui.extend({
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${sxt}/role/loadAllRole?" + params,
                page:{curr:1}
            })
        });
        ...
        table.on('tool(roleTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rolename + '】这个角色么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${sxt}/role/deleteRole", {roleid: data.roleid}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些角色么？', function (index) {
                //向服务端发送删除指令
                $.post("${sxt}/role/deleteBatchRole",params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据表格
                    tableIns.reload();
                })
        ...
        function openselectRoleMenu(data) {
            ...
            mainIndex=layer.open({
                ...
                yes:function (index, layero) {
                    ...
                    //保存角色和菜单的关系
                    $.post("${sxt}/role/saveRoleMenu",params,function (obj) {
                        layer.msg(obj.msg);
                        //关闭弹出层
                        layer.close(mainIndex);
                    })
                ...
                success:function (index) {
                    ...
                    menuTree = dtree.render({
                        ...
                        checkbarType:"all",
                        checkbarData:"choose",
                        url: "${sxt}/role/initRoleMenuTreeJson?roleid="+data.roleid
                    });
