...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${sxt}/customer/loadAllCustomer' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${sxt}/customer/loadAllCustomer?" + params,
                page: {curr: 1}
            })
        });
        ...
        $("#doExport").click(function () {
            var params = $("#searchFrm").serialize();
            window.location.href="${sxt}/stat/exportCustomer?"+params;
        });
        ...
        table.on('tool(customerTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.custname + '】这个客户么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${sxt}/customer/deleteCustomer", {identity: data.identity}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
        ...
        function openUpdateCustomer(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "${sxt}/customer/updateCustomer";
                }
            });
        }
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些客户么？', function (index) {
                //向服务端发送删除指令
                $.post("${sxt}/customer/deleteBatchCustomer", params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据表格
                    tableIns.reload();
                })
