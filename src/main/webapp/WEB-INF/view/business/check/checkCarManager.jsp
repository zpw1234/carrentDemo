...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${sxt}/check/checkRentExist", {rentid: rentid}, function (obj) {
        ...
        function initCheckFormData(rentid) {
            $.post("${sxt}/check/initCheckFormData",{rentid:rentid},function (obj) {
                //检查单
                var check=obj.check;
        ...
        form.on("submit(doSubmit)",function () {
            ...
            $.post("${sxt}/check/saveCheck",params,function (obj) {
                layer.msg(obj.msg);
                $("#content").hide();
            })
            return false;
