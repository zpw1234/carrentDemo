    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function initCarData() {
            ...
            tableIns = table.render({
                ...
                , url: '${sxt}/car/loadAllCar?isrenting=0' //数据接口
                , title: '车辆列表'//数据导出来的标题
                , height: 'full-150'
                , page: true  //是否启用分页
                , cols: [[   //列表数据
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${sxt}/rent/checkCustomerExist", params, function (obj) {
        ...
        form.on("submit(doSubmit)", function (obj) {
            ...
            $.post("${sxt}/rent/saveRent", params, function (obj) {
                layer.msg(obj.msg);
                //关闭弹出层
