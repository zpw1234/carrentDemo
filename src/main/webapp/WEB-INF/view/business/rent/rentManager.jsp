...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${sxt}/rent/loadAllRent?" + params,
                page: {curr: 1}
            })
        });
        ...
        table.on('tool(rentTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rentid + '】这个出租单么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${sxt}/rent/deleteRent", {rentid: data.rentid}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
                ...
                window.location.href="${sxt}/stat/exportRent?rentid="+data.rentid;
            }
        });
