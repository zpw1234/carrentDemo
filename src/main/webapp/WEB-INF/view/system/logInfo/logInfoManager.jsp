...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table','laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${sxt}/logInfo/loadAllLogInfo' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${sxt}/logInfo/loadAllLogInfo?" + params,
                page:{curr:1}
            })
        });
        ...
        table.on('tool(logInfoTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.loginname + '】这个日志么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${sxt}/logInfo/deleteLogInfo", {id: data.id}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些日志么？', function (index) {
                //向服务端发送删除指令
                $.post("${sxt}/logInfo/deleteBatchLogInfo",params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据表格
                    tableIns.reload();
                })
