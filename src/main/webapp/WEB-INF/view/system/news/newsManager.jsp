...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate', 'layedit'], function () {
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${sxt}/news/loadAllNews?" + params,
                page: {curr: 1}
            })
        });
        ...
        table.on('tool(newsTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.title + '】这个公告么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${sxt}/news/deleteNews", {id: data.id}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些公告么？', function (index) {
                //向服务端发送删除指令
                $.post("${sxt}/news/deleteBatchNews", params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据表格
                    tableIns.reload();
                })
